...
def write_cv_data(K, data_dir, idx, W, L, T, D, N, phi, alpha, beta, chains):
    ...
    write_pb_cv(data_dir, idx, W, T, D, alpha, beta, Bs)
    write_stan_cv(data_dir, idx, W, T, D, alpha, beta, Bs, chains=chains)
    write_prism_cv(data_dir, idx, W, T, D, alpha, beta, Bs)
    write_txt_cv(data_dir, idx, Bs, T, alpha, beta)
